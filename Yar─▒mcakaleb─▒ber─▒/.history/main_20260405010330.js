...
const WHATSAPP_NUMBER = "5551234567"; // Kendi numaranızla değiştirin

const PRODUCTS = [
  {
    id: "sivri-aci",
    name: "Sivri Acı Biber",
    desc: "Salata, turşu ve köz için yoğun aroma.",
    price: 89,
    unit: "kg",
    emoji: "🌶️",
    theme: "hot",
  ...
  },
  {
    id: "dolma",
    name: "Dolma Biber",
    desc: "Etli ve zeytinyağlı dolma için kalın etli.",
    price: 75,
    unit: "kg",
    emoji: "🫑",
    theme: "sweet",
  ...
  },
  {
    id: "carliston",
    name: "Çarliston",
    desc: "Hafif acı, ızgara ve sote için ideal.",
    price: 82,
    unit: "kg",
    emoji: "🫑",
    theme: "sweet",
  ...
  {
    id: "karisik-paket",
    name: "Karışık Taze Paket",
    desc: "1 kg karışık (stoka göre çeşitler).",
    price: 95,
    unit: "paket",
    emoji: "📦",
    theme: "mixed",
